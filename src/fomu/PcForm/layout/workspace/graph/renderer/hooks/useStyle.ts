...
export function createBorderStyle(element: PcElement): CSSProperties {
  return {
...
export function createFontStyle(element: PcElement): CSSProperties {
  return {
...
export function createAlignStyle(element: PcElement): CSSProperties {
  return {
    display: 'flex',
