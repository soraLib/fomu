...
import { PcRecord } from '@/fomu/PcForm/record'
import { BasicRecordType } from '@/fomu/record'
import { getRectangle } from '../utils/rectangle'
import { gridCeil, gridFloor } from './utils'

export function aheadSelected(element: PcElement, graph: PcGraph) {
...
export function selectOrAhead(element: PcElement, graph: PcGraph) {
