...
import { PredefineColors } from '@/fomu/utils/color'
import { isElementAttribute } from '@/fomu/utils/element'
import { isNullish } from '@/fomu/utils/function'

import { isGroupPlugin, SaPluginType } from '../../plugin'
  ...
  setup(props) {
    ...
    const createPluginContent = (): VNode => {
      ...
      switch (plugin.type) {
        ...
        default: {
          console.error(`[Fomu error]: Unexpected plugin type ${plugin.type}.`)
